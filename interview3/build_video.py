...
from the clean sentence-level audio in interview3/
...
# ============================================================
# CONFIG – updated for interview3
# ============================================================
AUDIO_DIR      = Path("interview3")
TIMINGS_JSON   = AUDIO_DIR / "timings.json"
FULL_AUDIO     = AUDIO_DIR / "full_interview.mp3"
SRT            = AUDIO_DIR / "interview.srt"

OUTPUT_DIR     = Path("interview3")
OUTPUT         = OUTPUT_DIR / "interview_partner_white_label_final.mp4"

# These video source files are expected to be in the same folder
# as this script (or adjust the paths if they live elsewhere)
...
DUAL_START = 5          # first 5 sentences (intro + long partner question)
DUAL_END   = 6          # last 6 sentences (thank you + closing)
...
def main():
    ...
    # Force the video to the exact audio length
    vf = (
