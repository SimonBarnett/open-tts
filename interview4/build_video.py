...
from the clean sentence-level audio in interview4/
...
# ============================================================
# CONFIG – updated for interview4
# ============================================================
AUDIO_DIR      = Path("interview4")
TIMINGS_JSON   = AUDIO_DIR / "timings.json"
FULL_AUDIO     = AUDIO_DIR / "full_interview.mp3"
SRT            = AUDIO_DIR / "interview.srt"

OUTPUT_DIR     = Path("interview4")
OUTPUT         = OUTPUT_DIR / "interview_marketing_door_final.mp4"
...
DUAL_START = 4          # first 4 sentences (intro)
DUAL_END   = 5          # last 5 sentences (closing)
