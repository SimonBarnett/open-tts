...
from open_tts.cues import ANIMATION_CHOICES, cue_from_yaml, cue_to_yaml_value, suggest_cue
...
class ScriptEditor(QWidget):
    ...
    def _on_anim_changed(self, combo: QComboBox) -> None:
        if self._suppress_suggest:
            return
        # User override is preserved in the combo; no auto rewrite.
        _ = combo
